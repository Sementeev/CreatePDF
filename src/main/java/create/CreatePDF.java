...
public class CreatePDF {
    ...
    public void Create(String numberpdf) throws IOException {
	    ...
	    String string_pdf2 = "Дополнительный текст, который выводится в PDF. При этом нужно понимать, что можно указать значение переменных, которые будут выводиться в файле PDF.";
