...
public class CreatePDF {
    ...
    public void Create(String numberpdf) throws IOException {
		...
		String string_pdf = "Добрый день замечательные группы ПИ второго курса кафедры АСУ УГАТУ! Текстовое приложение для создания файла.";
		Paragraph paragraph = new Paragraph();
	    paragraph.add(new Paragraph(string_pdf, new Font(times,14)));
	    
	    String string_pdf2 = "Дополнительный текст, который выводится в PDF. При этом нужно понимать, что можно указать значение перменных, которые будут выводиться в файле PDF.";
